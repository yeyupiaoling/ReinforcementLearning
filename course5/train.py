...
class Learner(object):
    def __init__(self, config):
        ...
        self.agent = AtariAgent(algorithm=algorithm,
        ...
        for i in range(self.config['predict_thread_num']):
            predict_thread = threading.Thread(target=self.run_predict, args=(i,))
    ...
    def learn_data_provider(self):
        ...
        while True:
            ...
            if len(self.batch_buffer['obs']) >= B:
                ...
                yield [obs_np, actions_np, advantages_np, target_values_np, self.lr, self.entropy_coeff]
        ...
        while True:
            ...
            if batch_obs:
                ...
                for i, ident in enumerate(batch_ident):
                    self.predict_output_queues[ident].put((actions[i], values[i]))
                batch_ident = []
                batch_obs = []
    ...
    def create_actors(self):
        ...
        for i in range(self.config['actor_num']):
            ...
            remote_thread = threading.Thread(target=self.run_remote_sample, args=(ident,))
    ...
    def run_remote_sample(self, ident):
        ...
        while True:
            ...
            next_obs, reward, done, info = remote_actor.step(action)
            ...
            logger.info('{} env reward: {}'.format(ident, self.remote_count))
